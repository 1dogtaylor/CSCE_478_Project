    ...
    def read_labels(self,path,data_size):
        ...
        for label in ground_truth:
            if label == 'Standing':
                ...
                gt.append(3)
            elif label == 'Udder away from heat lamp':
                gt.append(4)
            elif label == 'Udder toward to heat lamp':
                gt.append(5)
            elif label == 'Lying other':
                gt.append(6)
        return gt[:data_size]
